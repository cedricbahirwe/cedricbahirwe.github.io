...
const cedriSiteThemeId = "cedric.site.theme"
...
if (typeof(Storage) !== "undefined") {
    // Retrieve Theme
    rootDataset.theme =  localStorage.getItem(cedriSiteThemeId)
  } else {
...
function changeTheme(theme) {
    ...
    // Store Theme
    localStorage.setItem(cedriSiteThemeId, rootDataset.theme);
}
